...
public class OrderItemsService {
	...
	@Async
	public CompletableFuture<UserDetailsEntity> getUserDetailEntity(int id) {
		...
		return CompletableFuture.completedFuture(userDetail);
	}

	
	@Transactional(isolation = Isolation.DEFAULT,propagation = Propagation.REQUIRED)
	@Async("taskExecutor")
	public CompletableFuture<UserDetailsEntity> saveOrder(UserDetailsEntity userDetailsEntity) {
